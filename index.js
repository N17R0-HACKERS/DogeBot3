...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/918591220868`,
                "mediaType": "10",
                "mediaUrl": `wa.me/918591220868`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/918591220868`,
...
await xeon.setStatus(`Bot Meda By WHOAMI Bot Runig Time: ${uptime}`).catch((_) => _);
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "918591220868@s.whatsapp.net"
        dtod = '918591220868'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/itsmewhoami__/')
break
...
case 'script':
		case 'sc':
		case 'sourcecode':
		xeon.sendMessage(from, { text: "https://github.com/N17R0-HACKERS/DogeBot3", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/N17R0-HACKERS/DogeBot3"
        },
        "index": 0
      }
    ]
